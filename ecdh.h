...
//Finite Field Math
//--------------------------------------------------------------------------------------------------------------------------------------------
static mpz_class AddMod(mpz_class a, mpz_class b, mpz_class m)
{
	mpz_class r = a+b;
...
static mpz_class SubMod(mpz_class a, mpz_class b, mpz_class m)
{
	mpz_class r = a-b;
	mpz_mod(r.get_mpz_t(), r.get_mpz_t(), m.get_mpz_t());
	return r;
...
static mpz_class MultMod(mpz_class a, mpz_class b, mpz_class m)
{
	mpz_class r = a * b;
	mpz_mod(r.get_mpz_t(), r.get_mpz_t(), m.get_mpz_t());
	return r;
...
static mpz_class DivMod(mpz_class a, mpz_class b, mpz_class m)
{
	mpz_class r;
...
static mpz_class SqrMod(mpz_class x, mpz_class m)
{
	mpz_class r;
...
static mpz_class CubeMod(mpz_class x, mpz_class m)
{
	mpz_class r;
...
//Weierstrass curve
static void ECWeierAdd(mpz_class x1, mpz_class y1, mpz_class x2, mpz_class y2, mpz_class& x3, mpz_class& y3, mpz_class mod)
{
...
static void ECWeierDouble(mpz_class x, mpz_class y, mpz_class& x3, mpz_class& y3, mpz_class a, mpz_class mod)
{
...
static void ECWeierMultiply(mpz_class& Gx, mpz_class& Gy, mpz_class a, mpz_class k, mpz_class mod, unsigned int m = 255)
{
	mpz_class Qx = Gx;
	mpz_class Qy = Gy;
...
//------------------------------------------------------------------------
static void ECC_CreateKeys(mpz_class& K, mpz_class& X, mpz_class& Y, mpz_class a, mpz_class mod, mpz_class n, gmp_randclass& rng, bool montgomery = false)
{
...
static void ECC_Curve25519_Create(uint8_t pub[32], uint8_t k[32], gmp_randclass& rng)
{
